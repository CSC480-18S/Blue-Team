    ...
    public class QueryClass {
         ...
         * @return String array of the username and team related to the mac, null if nonexistent user or error
         */
         ...
         * @param word The dirty word plays
         */
        public void dirtyWordPlayed(String word){
            ...
            try(Connection con = DriverManager.getConnection(dbAddress, dbUser, dbPass)){
                ...
                ResultSet rs = preparedStmt.executeQuery();
                if(rs.next()){ //This dirty word has been played before, update its usage count
                    rs.updateInt("attempt_usage_count", (rs.getInt("attempt_usage_count") + 1));
                    rs.updateRow();
                } else{ //First time this dirty word was played. Create a new entry
         ...
         * @param points the score to add to the cumulative score
         */
         ...
         *
         * @param uname the user to update
         * @param bonus the bonus to add to the cumulative bonuses used
         */
	...
	*/
        ...
        */
        ...
        /*
* The test does not assume that the underlying population variances are equal and
