...
public class BoardGUI implements Runnable {
    ...
    public void gui() {
        ...
        jTable1.setBackground(new java.awt.Color(255, 204, 41));
    ...
    public class testUser {
        ...
        public testUser(int r, String n, int ts, int gp, int as) {
            rank = r;
            name = n;
            totalScore = ts;
            gamePlayed = gp;
        ...
        public testUser(String t, int v) {
            team = t;
            value = v;
        }
    ...
    public ArrayList TopPlayer() {
        ...
        testUser t1 = new testUser(1, "Ayo", 9453, 6, 3576);
        testUser t2 = new testUser(2, "Brandon", 5763, 4, 2647);
        testUser t3 = new testUser(3, "Baradan", 2424, 4, 1453);
        testUser t4 = new testUser(4, "Jason", 1453, 3, 546);
        testUser t5 = new testUser(5, "Jason 2.0", 1353, 8, 476);
    ...
    public ArrayList Statistics() {
        ArrayList<testUser> list = new ArrayList<>();
        testUser t1 = new testUser("Green", 3435, 1343, "VeryTired", 20, 6, 4, 45, 3);
        testUser t2 = new testUser("Gold", 4435, 2533, "VeryTired", 24, 8, 3, 25, 6);
